...
//        issueParam.put("goods_id", id);
        ...
        if (null != hotComment && hotComment.size() > 0) {
            ...
            commentInfo.put("content", Base64Coder.decode(hotComment.get(0).getContent()));
            ...
            if ((null == enabledCouponVos || enabledCouponVos.size() == 0)
                ...
                if (null != couponVos && couponVos.size() > 0) {
                    ...
                    if (null != footprintNum && null != couponVo.getMin_transmit_num()
                        ...
                        userCouponVo.setCoupon_id(couponVo.getId().toString());
...
//        issueParam.put("goods_id", id);
    ...
    public Object categorylist() {
        Map<String, List<CategoryVo>> resultObj = new HashMap();
        Integer id = null;
        ...
        List<CategoryVo> allCategory = categoryService.queryList(categoryParam);
        resultObj.put("allCategory", allCategory);
        return toResponsSuccess(resultObj);
    }
