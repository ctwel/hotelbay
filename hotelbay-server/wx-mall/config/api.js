...
module.exports = {
  IndexUrlGoodsList: NewApiRootUrl + 'index/list', //首页满足条件的商品
  ...
  GoodsAllCategory: NewApiRootUrl + 'goods/categorylist', //获得所有分类
  ...
  BrandAllList: NewApiRootUrl + 'brand/allList', //所有品牌

  CartList: NewApiRootUrl + 'cart/index', //获取购物车的数据
  CartAdd: NewApiRootUrl + 'cart/add', // 添加商品到购物车
  CartCheckPhone: NewApiRootUrl + 'order/check', // 添加商品到购物车
  ...
  UploadIDCard: NewApiRootUrl + 'order/uploadCard',  //提交身份证
