...
import com.platform.utils.Base64Coder;
...
public class UserController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        for(UserEntity user : userList) {
        	user.setUsername(Base64Coder.decode(user.getUsername()));
        	user.setNickname(Base64Coder.decode(user.getNickname()));
        	user.setPromoterName(Base64Coder.decode(user.getPromoterName()));
        }
    ...
    public R update(@RequestBody UserEntity user) {
    	user.setUsername(Base64Coder.encode(user.getUsername()));
    ...
    public R export(@RequestParam Map<String, Object> params, HttpServletResponse response) {
        ...
        if (userList != null && userList.size() != 0) {
            for (UserEntity userEntity : userList) {
                ...
                map.put("USERNAME", Base64Coder.decode(userEntity.getUsername()));
                map.put("Nickname", Base64Coder.decode(userEntity.getNickname()));
