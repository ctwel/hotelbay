$(function () {
    ...
    $("#jqGrid").Grid({
        ...
        colModel: [
            ...
            {
                label: '身份证正面图片', name: 'postscript', index: 'postscript', width: 80, formatter: function (value) {
                    return transImg(value);
                }
            },
            {
                label: '身份证反面图片', name: 'couponId', index: 'coupon_id', width: 80, formatter: function (value) {
                    return transImg(value);
                }
            },
            {
                label: '手持身份证图片', name: 'couponPrice', index: 'coupon_price', width: 80, formatter: function (value) {
                    return transImg(value);
                }
            },
